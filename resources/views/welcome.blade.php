<x-app-layout>
    <!-- HERO SECTION -->
    <section class="relative w-full py-space-3xl lg:py-space-4xl overflow-hidden text-center">
        ...
        <div class="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[400px] bg-tertiary/5 rounded-full blur-[160px]"></div>
        <div class="max-w-[1280px] mx-auto px-gutter-mobile lg:px-gutter-desktop relative z-10 flex flex-col items-center">
            <div class="inline-flex items-center gap-space-xs px-space-md py-1.5 rounded-full bg-surface-container-high/90 border border-outline-variant/40 shadow-lg shadow-black/20 mb-space-lg backdrop-blur-md">
                ...
                <span class="font-mono-code text-[12px] text-tertiary tracking-wide uppercase font-medium">HIGH-IMPACT COLLABORATIONS</span>
            </div>
            <h1 class="font-display-hero text-4xl sm:text-5xl lg:text-display-hero text-on-surface tracking-tight leading-[1.1] mb-space-md max-w-4xl mx-auto font-extrabold">
                We Build <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary via-tertiary to-secondary-fixed drop-shadow-[0_0_35px_rgba(123,208,255,0.3)]">Digital Experiences</span> That Scale.
            </h1>
            <p class="font-body-lg text-body-lg text-on-surface-variant max-w-3xl mx-auto mb-space-xl leading-relaxed">
                Award-winning web development, intuitive UI/UX design, and performance engineering for ambitious brands and high-growth venture-backed startups.
            </p>
            <div class="flex flex-wrap items-center justify-center gap-space-md mb-space-2xl">
                ...
                <a class="inline-flex items-center justify-center gap-space-xs px-space-xl py-space-md rounded-lg bg-surface-container-high border border-outline-variant/40 text-on-surface font-label-md text-label-md transition-all duration-300 hover:bg-surface-bright hover:border-outline-variant hover:-translate-y-0.5 font-medium shadow-md" href="#estimator">
                    <span class="material-symbols-outlined text-tertiary text-[18px]">bolt</span>
                    <span>Start a Project</span>
                </a>
            </div>

            <div class="w-full max-w-2xl mx-auto text-left relative group">
                <div class="absolute -inset-1 bg-gradient-to-r from-primary/30 via-tertiary/20 to-secondary/30 rounded-2xl blur-xl opacity-60 group-hover:opacity-100 transition duration-500"></div>
                <div class="relative rounded-xl bg-surface-container-low border border-outline-variant/30 p-space-md shadow-2xl backdrop-blur-xl">
                    <div class="flex items-center justify-between pb-space-sm border-b border-outline-variant/20 mb-space-sm">
                        <div class="flex items-center gap-2">
                            <span class="w-3 h-3 rounded-full bg-error/90 inline-block"></span>
                            <span class="w-3 h-3 rounded-full bg-secondary/90 inline-block"></span>
                            <span class="w-3 h-3 rounded-full bg-tertiary/90 inline-block"></span>
                            <span class="ml-space-xs font-mono-code text-[12px] text-on-surface-variant/80">mooney.config.ts</span>
                        </div>
                        <div class="flex items-center gap-space-xs">
                            <span class="inline-block w-1.5 h-1.5 rounded-full bg-tertiary animate-pulse"></span>
                            <span class="font-mono-code text-[12px] text-tertiary">TypeScript 5.4 • Ready</span>
                        </div>
                    </div>
                    <div class="bg-surface-container-lowest/90 p-space-md rounded-lg font-mono-code text-mono-code leading-relaxed overflow-x-auto border border-outline-variant/20">
                        <p><span class="text-primary-container">const</span> <span class="text-primary">mooney</span> = {</p>
                        <p class="pl-4"><span class="text-tertiary">what</span>: <span class="text-secondary">"Digital Craft Studio"</span>,</p>
                        <p class="pl-4"><span class="text-tertiary">focus</span>: [<span class="text-secondary">"Modern Web Development"</span>, <span class="text-secondary">"UI/UX & Design Systems"</span>],</p>
                        <p class="pl-4"><span class="text-tertiary">mindset</span>: <span class="text-secondary">"Obsessed with details & scalable performance"</span>,</p>
                        <p class="pl-4"><span class="text-tertiary">status</span>: <span class="text-primary-fixed">"Ready to launch your vision 🚀"</span></p>
                        <p>};</p>
                        <p class="mt-2 text-tertiary/80 text-[12px] border-t border-outline-variant/15 pt-2">&gt; Mooney initialized: Zero friction, instant deployment.</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="w-full py-space-4xl bg-surface-container-lowest relative overflow-hidden" id="case-studies">
    ...
    <section class="w-full py-space-4xl relative" id="services">
        <div class="max-w-[1280px] mx-auto px-gutter-mobile lg:px-gutter-desktop">
            <div class="max-w-2xl mb-space-3xl text-center mx-auto">
                ...
                <h2 class="font-headline-xl text-3xl sm:text-headline-xl text-on-surface mb-space-md font-bold tracking-tight">
                    Specialized Services Built for Rapid Growth
                </h2>
                <p class="font-body-lg text-body-lg text-on-surface-variant">
                    We combine rigorous computer science with obsessive design craft to build interfaces that dominate markets and command premium perception.
                </p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-space-xl max-w-4xl mx-auto">
                <div class="group relative rounded-2xl bg-surface-container-low p-space-xl flex flex-col justify-between hover:-translate-y-1.5 transition-all duration-300 shadow-xl border border-outline-variant/30 hover:border-primary/40 backdrop-blur-md">
                    <div>
                        <div class="w-14 h-14 rounded-2xl bg-surface-container-high border border-outline-variant/40 flex items-center justify-center mb-space-lg group-hover:bg-primary/20 group-hover:border-primary/50 transition-all shadow-md">
                            <span class="material-symbols-outlined text-primary text-[28px]">terminal</span>
                        </div>
                        <h3 class="font-headline-md text-headline-md text-on-surface mb-space-sm font-bold">Custom Web Development</h3>
                        <p class="font-body-md text-body-md text-on-surface-variant mb-space-lg leading-relaxed">
                            Scalable, clean frontend architectures and high-performance web applications built with Next.js, React, Tailwind, and robust enterprise infrastructures.
                        </p>
                    </div>
                    <div class="pt-space-md border-t border-outline-variant/20">
                        <div class="flex flex-wrap gap-space-2xs">
                            <span class="px-space-xs py-1 rounded-md bg-surface-container-high border border-outline-variant/30 text-primary font-mono-code text-[11px]">Next.js</span>
                            <span class="px-space-xs py-1 rounded-md bg-surface-container-high border border-outline-variant/30 text-primary font-mono-code text-[11px]">React</span>
                            <span class="px-space-xs py-1 rounded-md bg-surface-container-high border border-outline-variant/30 text-primary font-mono-code text-[11px]">Tailwind CSS</span>
                            <span class="px-space-xs py-1 rounded-md bg-surface-container-high border border-outline-variant/30 text-primary font-mono-code text-[11px]">TypeScript</span>
                            <span class="px-space-xs py-1 rounded-md bg-surface-container-high border border-outline-variant/30 text-primary font-mono-code text-[11px]">GraphQL</span>
                        </div>
                    </div>
                </div>
                <div class="group relative rounded-2xl bg-surface-container-low p-space-xl flex flex-col justify-between hover:-translate-y-1.5 transition-all duration-300 shadow-xl border border-outline-variant/30 hover:border-secondary/40 backdrop-blur-md">
                    <div>
                        <div class="w-14 h-14 rounded-2xl bg-surface-container-high border border-outline-variant/40 flex items-center justify-center mb-space-lg group-hover:bg-secondary/20 group-hover:border-secondary/50 transition-all shadow-md">
                            <span class="material-symbols-outlined text-secondary text-[28px]">layers</span>
                        </div>
                        <h3 class="font-headline-md text-headline-md text-on-surface mb-space-sm font-bold">UI/UX & Design Systems</h3>
                        <p class="font-body-md text-body-md text-on-surface-variant mb-space-lg leading-relaxed">
                            Human-centered interfaces, cohesive atomic design systems, micro-interactions, dark-mode kinetics, and pixel-perfect design tokens built for scale.
                        </p>
                    </div>
                    <div class="pt-space-md border-t border-outline-variant/20">
                        <div class="flex flex-wrap gap-space-2xs">
                            <span class="px-space-xs py-1 rounded-md bg-surface-container-high border border-outline-variant/30 text-secondary font-mono-code text-[11px]">Figma Tokens</span>
                            <span class="px-space-xs py-1 rounded-md bg-surface-container-high border border-outline-variant/30 text-secondary font-mono-code text-[11px]">Atomic Systems</span>
                            <span class="px-space-xs py-1 rounded-md bg-surface-container-high border border-outline-variant/30 text-secondary font-mono-code text-[11px]">Micro-Interactions</span>
                            <span class="px-space-xs py-1 rounded-md bg-surface-container-high border border-outline-variant/30 text-secondary font-mono-code text-[11px]">WCAG 2.1</span>
                            <span class="px-space-xs py-1 rounded-md bg-surface-container-high border border-outline-variant/30 text-secondary font-mono-code text-[11px]">Prototypes</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="w-full pb-space-4xl pt-space-2xl relative" id="compare">
        <div class="max-w-[1280px] mx-auto px-gutter-mobile lg:px-gutter-desktop">
            <div class="text-center max-w-3xl mx-auto mb-space-3xl">
                <div class="inline-flex items-center gap-space-xs px-space-sm py-1 rounded-full bg-secondary-container/20 text-secondary font-mono-code text-label-sm uppercase tracking-wider mb-space-sm border border-secondary/20">
            ...
            <div class="rounded-2xl border border-outline-variant/30 bg-[#161B22] shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden">
            ...
            <div class="mt-space-lg text-center font-body-sm text-body-sm text-on-surface-variant">
                Still undecided? <a class="text-primary hover:text-primary-fixed underline font-medium transition-colors" href="#estimator">Chat with our team</a> — we will help tailor the perfect package for your scope & budget.
            </div>
        </div>
    </section>
        ...
        <div class="max-w-[1280px] mx-auto px-gutter-mobile lg:px-gutter-desktop relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-space-2xl items-start">
                    ...
                    <div class="flex flex-col gap-space-md w-full mb-space-xl">
                        <a class="flex items-center gap-space-sm p-space-md rounded-xl bg-surface-container-low border border-outline-variant/30 hover:border-tertiary/50 hover:bg-surface-container transition-all group shadow-md" href="https://whatsapp.com" target="_blank">
                            <div class="w-10 h-10 rounded-lg bg-surface-container-high flex items-center justify-center group-hover:bg-tertiary/20 transition-colors">
                                <span class="material-symbols-outlined text-tertiary text-[24px]">chat</span>
                            </div>
                            <div>
                ...
                <div class="lg:col-span-7 w-full">
                    <div class="rounded-2xl bg-surface-container-low border border-outline-variant/30 p-space-xl lg:p-space-2xl shadow-2xl backdrop-blur-md">
                        <form action="#" method="POST" class="flex flex-col gap-space-lg" id="project-form">
                            @csrf
